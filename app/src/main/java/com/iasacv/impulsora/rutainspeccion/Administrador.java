...
public class Administrador extends Activity{
    ...
    private class insertRutaInspeccion extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            loadProgressDialog = ProgressDialog.show(Administrador.this, "", "Insertando informacion...", true, false);
        }
    ...
    public void llenarCombos(){
        ...
        ArrayAdapter<String> adaptador = new ArrayAdapter<String>(Administrador.this, android.R.layout.simple_list_item_1, ciclos);
