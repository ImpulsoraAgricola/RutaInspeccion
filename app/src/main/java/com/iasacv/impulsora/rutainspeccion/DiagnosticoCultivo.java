...
public class DiagnosticoCultivo extends ActionBarActivity {
    ...
    public void llenarCombos() {
        ...
        ArrayAdapter<Combo> adapterCiclo = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaCiclos);
        ...
        ArrayAdapter<Combo> adapterSistemaProduccion = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaSistemaProduccion);
        ...
        ArrayAdapter<Combo> adapterArregloTopologico = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaArregloTopologico);
        ...
        ArrayAdapter<Combo> adapterEtapaFenologica = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaEtapaFenologica);
        ...
        ArrayAdapter<Combo> adapterCondicionDesarrollo = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaCondicionDesarrollo);
        ...
        ArrayAdapter<Combo> adapterPlaga = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaPlaga);
        rutainspeccion_sPlaga.setAdapter(adapterPlaga);

        //Malezas
        List<Combo> listaMaleza = _objCatalogosBP.GetAllMalezaCombo();
        ArrayAdapter<Combo> adapterMaleza = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaMaleza);
        rutainspeccion_sMaleza.setAdapter(adapterMaleza);

        //Enfermedades
        List<Combo> listaEnfermedad = _objCatalogosBP.GetAllEnfermedadCombo();
        ArrayAdapter<Combo> adapterEnfermedad = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaEnfermedad);
        ...
        ArrayAdapter<Combo> adapterEstadoPlaga = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaEstadoPlaga);
        ...
        ArrayAdapter<Combo> adapterEstadoMaleza = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaEstadoMaleza);
        ...
        ArrayAdapter<Combo> adapterEstadoEnfermedad = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaEstadoEnfermedad);
        ...
        ArrayAdapter<Combo> adapterPotencialRendimiento = new ArrayAdapter<Combo>(this, android.R.layout.simple_spinner_item, listaPotencialRendimiento);
